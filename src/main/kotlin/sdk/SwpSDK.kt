...
data class Swipe(private val apiKey: String,
    ...
    fun getAllAccounts(pagination: PaginationParams? = null, filter: FilterDTO? = null): SuccessResponse<List<DataDTOReceipt<AccountDTO>>> {
    ...
    fun getAllAssets(pagination: PaginationParams? = null, filter: FilterDTO? = null): SuccessResponse<List<DataDTOReceipt<AssetDTO>>> {
        return SuccessResponse.fromDataListRes(
                request(
                        method = Methods.GET,
                        path = "assets",
    ...
    fun getAllTransfers(accountID: String, pagination: PaginationParams? = null): SuccessResponse<List<DataDTOReceipt<TransferDTO>>> {
        return SuccessResponse.fromDataListRes(
                request(
                        method = Methods.GET,
